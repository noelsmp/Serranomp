...
public class PdfService(IJSRuntime js)
{
    ...
    public async Task ShareZugferdAsync(Rechnung rechnung, PraxisDaten praxis, string zugferdXml) =>
        await js.InvokeVoidAsync("praxisPdf.shareZugferd", rechnung, praxis, zugferdXml);
}
